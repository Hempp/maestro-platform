 ...
 * Designed for LinkedIn sharing, employer validation, and print.
 *
 * Features:
 * - Professional certificate display with animated verification badge
 * - Blockchain proof visualization (SBT on Polygon)
 * - QR code for quick mobile verification
 * - Social sharing (LinkedIn, X/Twitter, copy link)
 * - Print-friendly layout with proper media queries
 * - Issuer and holder information display
 * - Expiration countdown for near-expiry certificates
 */
