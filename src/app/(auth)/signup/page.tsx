...
/**
 * SIGNUP PAGE
 * Clean registration interface matching Phazur design
 */
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#1a1d21] text-slate-500">Or continue with</span>
            </div>
          </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <button
              type="button"
              className="flex items-center justify-center gap-2 px-4 py-2.5 bg-[#2a2d32] border border-slate-700 rounded-xl text-slate-300 hover:bg-[#3a3d42] transition"
            >
