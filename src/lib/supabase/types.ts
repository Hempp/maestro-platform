...
export interface Database {
  public: {
    Tables: {
      ...
      pending_mints: {
        Row: {
          ...
          status: 'pending_wallet' | 'queued' | 'minting' | 'completed' | 'failed' | 'cancelled';
          wallet_address: string | null;
          transaction_hash: string | null;
          token_id: string | null;
          error: string | null;
    ...
    Enums: {
      ...
      pending_mint_status: 'pending_wallet' | 'queued' | 'minting' | 'completed' | 'failed' | 'cancelled';
      claimable_status: 'pending' | 'claimed' | 'expired' | 'cancelled';
      certification_status: 'submitted' | 'under_review' | 'passed' | 'failed' | 'needs_revision';
    };
  };
}
